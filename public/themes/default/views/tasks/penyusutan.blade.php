               ...
               <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <div class="well" style="overflow: auto">
                        <form class="form-inline" method="get" action="{{ route('penyusutan_page')}}">
...
<option va                                                      lue="mouth">Word of mouth  2</option>
                     ...
                     <div class="table-responsive" style="overflow-y: hidden;">
                        <form id="myFormRkauedit" method="post" class="form-horizontal form-label-left">
                           <input type="hidden" name="urlsavepenyusutansuccess"  value="{!!  route('penyusutan_page', ['mode' => 'grid' ,  'page'=> $paging['pageNo'], 'sort'=>'', 'rp'=>'' ]) !!}">
                           <input type="hidden" name="urlsavepenyusutan"  value="{{ route('penyusutan_save') }}">
                           ...
                           <table class="table-style-form">
                              ...
                              <tbody>
                                 @if(count($list))
                                 <?php $i = $paging['pageNo'] == 1 ? 1 : ($paging['pageNo'] * $paging['totalPerPage'] - ($paging['totalPerPage'] - 1) );  $sSum = 0; ?>
                                 @foreach($list as $row)
  ...
  <!--                                    <td style="text-align: center;">
                                    ...
                                    <td  class="text-right">
                                       ...
                                       <input type="text" class="text-right" id="{{ 'c-'.$i }}"name="biaya[]" value="{{ number_format($row['biaya']) }}"  style="width: 95px" onkeyup="generateSum(this);" >

                                    </td>
                          
                                 </tr>
                                 <?php $sSum = $sSum + $row['biaya'] ?> 
                                 ...
                                 @endforeach
                                    ...
                                    <td  class="text-right">
                                       <input type="text" class="text-right" id="c-23" value="{{ number_format($sSum) }}"  style="width: 95px" onkeyup="generateSum(this);" >
                     ...
                     <!--                     <div class="row">
                                             <div class="col-sm-5">
                                                <div class="pull-left">
                                                   ...
                                                   <input type="hidden" id="jumptopageinput" value="{{ route('penyusutan_page') }}" />
                                             ...
                                             <div class="col-sm-7">
                                                ...
                                                <div class="btn-group  pull-right">
                                                   <a class="btn btn-default btn-sm {!! $paging['pageNo'] == 1 ? 'disabled' : '' !!}" id="btn_prevpage" href="{!! $paging['pageNo'] == 1 ? '#' : route('penyusutan_page', [ 'mode' => $mode, 'page'=>($paging['pageNo']-1), 'sort'=>'', 'rp'=>'']) !!}"><span class="fa fa-arrow-left">&nbsp;</span></a>
                                                   <input id="pageinput" class="fl btn pageinput" type="text" value="{{ $paging['pageNo'] }}" />
                                                   <a class="btn btn-default btn-sm {!! $paging['pageNo'] == $paging['totalPage'] ? 'disabled' : '' !!}" id="btn_nextpage" href="{!! $paging['pageNo'] == $paging['totalPage'] ? '#' : route('penyusutan_page', [  'mode' => $mode, 'page'=>($paging['pageNo']+1), 'sort'=>'', 'rp'=>'']) !!}"><span class="fa fa-arrow-right">&nbsp;</span></a>
                                                </div>
                                                @endif
                                             </div>
                                          </div>-->
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <form id="myFormUser" method="post" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="">
            <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
            <input type="hidden" name="urladd" value="{{ route('penyusutan_add') }}">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     Please download template first! <a href="{{ route('penyusutan_down') }}" target="_blank"><b>click here</b></a>
                  </div>
               </div>
               <div class="form-group">
...
<!--<div class="modal fade bs-example-modal-lg" id="myForm" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <form id="myFormUser" method="post" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="">
            <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
            <input type="hidden" name="urladd" id="token" value="{{ route('penyusutan_add') }}">
